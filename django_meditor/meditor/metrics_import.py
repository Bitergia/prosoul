...
# -*- coding: utf-8 -*-
#
# Load CROSSMINER metrics definition in Meditor
#
...
from meditor.models import DataSourceType, Metric


def get_params():
    parser = argparse.ArgumentParser(usage="usage: metrics_import.py [options]",
                                     description="Load CROSSMINER metrics definition in Meditor")
