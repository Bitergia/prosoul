...
urlpatterns_edit = [
    ...
    url(r'^update_goal$', views_editor.update_goal),
    url(r'^select_goal$', views_editor.select_goal),
    url(r'^add_attribute$', views_editor.add_attribute),
    url(r'^select_attribute$', views_editor.select_attribute),
    url(r'^remove_attribute$', views_editor.remove_attribute),
    url(r'^update_attribute$', views_editor.update_attribute),
